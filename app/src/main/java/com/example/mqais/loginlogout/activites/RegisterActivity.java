...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews(){
        ...
        appCompatButtonRegister = (AppCompatButton) findViewById(R.id.appCompactButtonRegister);
    ...
    private void postDataToSQLite(){
        if (!inputValidation.isInputEditTextFilled(textInputEditTextName, textInputLayoutName, getString(R.string.error_massage_name))){
            return;
        }
